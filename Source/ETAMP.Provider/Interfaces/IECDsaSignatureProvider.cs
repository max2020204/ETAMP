...
public interface IECDsaSignatureProvider : IInitialize
{
    ...
    ///     A token to signal the cancellation of the asynchronous operation. Defaults to <see cref="CancellationToken.None" />
    ///     if none is provided.
    /// </param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the signed <see cref="ETAMPModel{T}" />
    ///     object.
    /// </returns>
