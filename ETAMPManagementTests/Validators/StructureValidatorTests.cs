...
public class StructureValidatorTests
{
    ...
    {
        var validJson =
            $"{{\"Id\":\"{Guid.NewGuid()}\",\"Token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkVUQU1QIn0..\",\"UpdateType\":\"Update\",\"SignatureToken\":\"Signature\"}}";
    ...
    {
        var etamp =
            $"{{\"Id\":\"{Guid.NewGuid()}\",\"Token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkVUQU1QIn0..\",\"UpdateType\":\"Update\",\"SignatureToken\":\"Signature\",\"SignatureMessage\":\"Message\"}}";
    ...
    {
        var invalidEtamp =
            $"{{\"Id\":\"{Guid.NewGuid()}\",\"Token\":\"\",\"UpdateType\":\"Update\",\"SignatureToken\":\"Signature\",\"SignatureMessage\":\"Message\"}}";
    ...
    public void ValidateIdConsistency_WithConsistentId_ReturnsTrue()
    {
        ...
        var etamp =
            "{\"Id\":\"9C9719B5-0D8E-4F69-9878-A3510CDC26F0\",\"Token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkVUQU1QIn0.eyJNZXNzYWdlSWQiOiI5Qzk3MTlCNS0wRDhFLTRGNjktOTg3OC1BMzUxMENEQzI2RjAiLCJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.8pCZwNn46YgdpbK8ur4egT_18oGwqYeGmb2umI6Y2Dk\",\"UpdateType\":\"Update\",\"SignatureToken\":\"Signature\",\"SignatureMessage\":\"Message\"}";
    ...
    {
        var etamp =
            $"{{\"Id\":\"{Guid.NewGuid()}\",\"Token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkVUQU1QIn0..\",\"UpdateType\":\"Update\"}}";
    ...
    public void ValidateETAMPStructure_WithInvalidModel_ThrowsInvalidOperationException()
    {
        ...
        var result = _validator.ValidateETAMPStructure(model);
        Assert.False(result.IsValid);
        Assert.Equal("ETAMP model is invalid: it is either null, has empty/missing fields, or contains invalid values",
            result.ErrorMessage);
    }
    ...
    public void ValidateIdConsistency_WithInconsistentId_ReturnsFalse()
    {
        ...
        var etamp =
            "{\"Id\":\"9C9719B5-0D8E-4F69-9878-A3510CDC26F1\",\"Token\":\"eyJhbGciOiJIUzI1NiIsInR5cCI6IkVUQU1QIn0.eyJNZXNzYWdlSWQiOiI5Qzk3MTlCNS0wRDhFLTRGNjktOTg3OC1BMzUxMENEQzI2RjAiLCJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.8pCZwNn46YgdpbK8ur4egT_18oGwqYeGmb2umI6Y2Dk\",\"UpdateType\":\"Update\",\"SignatureToken\":\"Signature\",\"SignatureMessage\":\"Message\"}";
