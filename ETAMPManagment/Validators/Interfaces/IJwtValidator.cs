...
public interface IJwtValidator
{
    ...
    /// <returns>
    ///     A task that represents the asynchronous validation operation, yielding a JwtValidationResult that describes
    ...
    /// <summary>
    ///     Asynchronously validates a JWT token, including its audience and issuer claims, using a specified ECDsa security
    ///     key.
    /// </summary>
    /// <param name="token">The JWT token as a string to be validated.</param>
